...
#      line20,=plt.plot(x,rez[19],label="L20")
      plt.legend(handles=[line1,line2,line3,line4]) #,line4,line5,line6,line7,line8,line9,line10,line11,line12,line13,line14,line15,line16,line17,line18,line19,line20])
      plt.pause(0.1)
      if len(array)==20:
        strg=str(date.today())+","+str(ttime)+","+str(array[0])+","+str(array[1])+","+str(array[2])+","+str(array[3]) #+","+str(array[4])+","+str(array[5])+","+str(array[6])+","+str(array[7])+","+str(array[8])+","+str(array[9])+","+str(array[10])+","+str(array[11])+","+str(array[12])+","+str(array[13])+","+str(array[14])+","+str(array[15])+","+str(array[16])+","+str(array[17])+","+str(array[18])+","+str(array[19])
        f.write(strg+"\n")
      else:
        f.write(str(array)+"\n")
